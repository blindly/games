						...
						'<div id="demo-modal">' +
							'<section>' +
								...
								'<ul class="actions vertical">' +
									'<li><ul class="social"><li class="facebook"><div class="fb-like" data-href="http://templated.co" data-send="false" data-layout="button" data-width="100" data-show-faces="true"></div></li><li class="twitter"><a href="https://twitter.com/share" class="twitter-share-button" data-url="https://templated.co" data-text="TEMPLATED = awesome CSS, HTML5, and responsive site template freebies." data-count="horizontal">Tweet</a><script type="text/javascript" src="https://platform.twitter.com/widgets.js"></script></li><li class="google-plus"><div class="g-plusone" data-size="medium" data-href="https://templated.co"></div></li></ul></li>' +
